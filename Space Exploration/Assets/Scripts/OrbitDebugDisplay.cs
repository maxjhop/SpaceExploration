...
public class OrbitDebugDisplay : MonoBehaviour
{
    ...
    void DrawOrbits()
    {
        ...
        for (int step = 0; step < numSteps; step++)
        {
            ...
            for (int i = 0; i < virtualBodies.Length; i++)
            {
                //print(CalculateAcceleration(i, virtualBodies) * timeStep);
    ...
    Vector3 CalculateAcceleration(int i, VirtualBody[] virtualBodies)
    {
        ...
        for (int j = 0; j < virtualBodies.Length; j++)
        {
            ...
            //print("sqr dist" + sqrDst);
            //acceleration += forceDir * Universe.gravitationalConstant * virtualBodies[j].mass / sqrDst;
            //print(virtualBodies[j].mass); 
            acceleration += forceDir * 667.4f * virtualBodies[j].mass / sqrDst;
